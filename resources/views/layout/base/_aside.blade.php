...
<div class="aside aside-left {{ Metronic::printClasses('aside', false) }} d-flex flex-column flex-row-auto"
    ...
    {{-- Brand --}}
    <div class="brand flex-column-auto {{ Metronic::printClasses('brand', false) }} mt-8" id="kt_brand">
        <div class="brand-logo">
            <a href="{{ url('/') }}">
                {{-- <img alt="{{ config('app.name') }}" src="{{ asset('media/logos/'.$kt_logo_image) }}" style="height:25px !important;"/> --}}
                <!-- <img alt="{{ config('app.name') }}" src="{{ asset('sajilobroker2.jpg') }}"
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4 {{ Metronic::printClasses('aside_menu', false) }}"
            ...
            <ul class="menu-nav {{ Metronic::printClasses('aside_menu_nav', false) }}">
                {{ Menu::renderVerMenu(\App\Http\Controllers\MenuController::menu()) }}
            </ul>
        </div>
    </div>
